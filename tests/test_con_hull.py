"""Tests for the :mod:`con_hull` module."""
...
def test_con_hull(
    ...
    """Test :func:`con_hull` evaluation matches or bounds the original
    function.

    """

    (f_hull, f_prime_hull, f_double_prime_hull) = con_hull(
        function,
        interval,
        side,
    ...
    xs: Array = xp.linspace(interval[0], interval[1], 100)
    ys: Array = function(xs)
    ys_prime: Array = function_prime(xs)
    ys_double_prime: Array = function_double_prime(xs)
    ys_hull: Array = f_hull(xs)
    ys_hull_prime: Array = f_prime_hull(xs)
    ys_hull_double_prime: Array = f_double_prime_hull(xs)
