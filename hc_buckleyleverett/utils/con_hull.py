...
def con_hull(
    ...
    **kwargs: Any,
    ...
    """Returns the convex/concave hull of a function (and its derivatives) as a new function.

    Parameters:
        f: A function that takes an x value and returns a y value.
        interval: A tuple containing the start and end of the interval to consider.
        side: Whether to return the upper concave or lower convex hull.
    ...
    if f_prime is not None:
        ...
        def f_prime_hull(x: float | Array) -> Array:
            """Returns the first derivative of the convex/concave hull at a given x
            value.
    ...
    if f_double_prime is not None:
        ...
        def f_double_prime_hull(x: float | Array) -> Array:
            """Returns the second derivative of the convex/concave hull at a given x
            value.
